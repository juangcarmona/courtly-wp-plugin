<div class="wrap">
  ...
  <table class="table table-bordered w-auto">
    <tr><th><?php esc_html_e('ID', 'courtly'); ?></th><td><?= esc_html($data['id']) ?></td></tr>
    <tr><th><?php esc_html_e('User', 'courtly'); ?></th><td><?= esc_html($data['user']) ?></td></tr>
    <tr><th><?php esc_html_e('Court', 'courtly'); ?></th><td><?= esc_html($data['court']) ?></td></tr>
    <tr><th><?php esc_html_e('Date', 'courtly'); ?></th><td><?= esc_html($data['date']) ?></td></tr>
    <tr><th><?php esc_html_e('Time Slot', 'courtly'); ?></th><td><?= esc_html($data['slot']) ?></td></tr>
  </table>
  ...
  <div class="d-flex gap-3 mt-4">
    ...
    <?php elseif ($data['cancel_blocked_message']): ?>
      <p class="text-muted align-self-center mb-0">
        <em><?= esc_html__($data['cancel_blocked_message'], 'courtly') ?></em>
      </p>
    <?php endif; ?>
